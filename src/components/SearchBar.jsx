...
const SearchBar = ({onSearch, setError}) => {
  ...
  return (
    <>
    <form onSubmit={handleSubmit} className='mx-auto text-center py-2 flex flex-row gap-4 justify-between items-center'>
    <Link to='/about' className='font-bold text-[#eef]'>About</Link>
